...
export async function getHomepage(): Promise<HomepageData> {
  return {
    ...
    heroImage: {
      url: "https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?w=2000&q=85&auto=format&fit=crop",
    ...
    centres: [
      { title: "University Preparatory College", body: "Foundation and bridging study for school leavers and mature entrants." },
      { title: "Distance & Flexible Learning Centre", body: "Study from the provinces through flexible and distance delivery." },
      { title: "Office of Research & Postgraduate Studies", body: "Masters, doctoral supervision, and applied research programs." },
      { title: "Institute of Governance, Diplomacy and Development", body: "Policy research, short courses, and public-sector training." },
    ],
