...
export function CourseCard({ code, title, school, credits, semester, level, onClick, style }: CourseCardProps) {
  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
        ...
        {level && (
          <span style={{ fontFamily: "var(--font-sans)", fontSize: 12, fontWeight: 600, letterSpacing: ".06em", textTransform: "uppercase", color: "var(--text-faint)" }}>
            {level}
          </span>
        )}
      </div>
      <div
        style={{
          ...
          fontSize: 19,
          lineHeight: 1.3,
          color: h ? "var(--link-hover)" : "var(--text-heading)",
